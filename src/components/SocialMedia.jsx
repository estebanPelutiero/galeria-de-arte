...
const SocialMedia = () => {
  return (
    <section className='max-w-[1366px] mx-auto lg:flex flex-col items-start px-4 md:px-9 lg:px-16'>
      ...
      <div className='flex justify-evenly items-center mb-6 w-full h-24 rounded-lg bg-white shadow-md'>
